...
rm(list=ls(all=TRUE))
source("~/Thèse/Codes/Suisse/RFA_REGPD/RFA_function.R")#functions for RFA clustering, see Le Gall et al., 2020
source("~/Thèse/Codes/ClusterMax/R/PAMfmado.R.R")# function for F-madogram clustering, see Bador et al., 2015
...
load(file = "~/Thèse/Codes/Suisse/KL/MetaDataPluieTriee.RData")#localisation, etc.
...
ordering[order] = temp#ordre des clusters selon les coordonnées des pts des medoides
spatial_order_clusters$order = ordering #on ajoute la colone des numéros de clusters
...
#save(MatPluieClust2,file="~/Thèse/Codes/Suisse/precip_cluster2.RData")
...
#save(REGPD_test_info_reg,file = '~/Thèse/Codes/Suisse/RFA_Hos05/REGPD_hos05/REGPD_homo_test.RData')
